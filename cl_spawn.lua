...
RegisterCommand('stest', function()
	TriggerEvent('gr-spawn:opennui')
end)

RegisterNetEvent("gr-spawn:opennui")
AddEventHandler("gr-spawn:opennui", function(pos)
	DoScreenFadeIn(500)
...
RegisterNUICallback('sonkonum', function(data, cb)
    ...
    QBCore.Functions.GetPlayerData(function(PlayerData) 
        TriggerEvent("gr-spawn:client:loadplayer", PlayerData.position)
    end)
end)

RegisterNetEvent("gr-spawn:client:loadplayer")
AddEventHandler("gr-spawn:client:loadplayer", function(coords)
    delCam()
